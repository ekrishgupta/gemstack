/**
 * gemstack browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.gemstack/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.gemstack/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['gemstack browse — headless browser for AI agents', '', 'Commands:'];
